...
using TMPro;
using RPGProject.Feature.PlayerMenu;
...
using static RPGProject.Feature.Characters.CharacterDatabase;
using static RPGProject.Feature.Characters.MonsterDatabase;
...
namespace RPGProject.Feature.Characters
{
    public class StatusUIController : MonoBehaviour
    {
        ...
        private void HandleInput()
        {
            ...
            if (GameInput.GetSelectDown()) ShowresonanceStatusUI();
        ...
        private void RefreshUI()
        {
            ...
            if (statusFxText != null)
                statusFxText.text = StatusEffectText.Summary(charData.StatusEffects, true);
