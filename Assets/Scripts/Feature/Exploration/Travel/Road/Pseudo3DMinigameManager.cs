...
namespace RPGProject.Feature.Exploration
{
    ...
    public class Pseudo3DMinigameManager : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            _isSkidding = false;
            if (ManagerRoot.Sound != null) ManagerRoot.Sound.StopSFX(SfxID.Car_Skid);
        ...
        private void HandlePlayerInput(float currentCurve)
        {
            ...
            {
                _isSkidding = true;
                if (!ManagerRoot.Sound.IsSfxPlaying(SfxID.Car_Skid))
                    ManagerRoot.Sound.PlaySFX(SfxID.Car_Skid, 1.0f, 1.0f, true); 
            }
            else if (!isDrifting && _isSkidding)
            {
                ...
                _isSkidding = false;
                if (ManagerRoot.Sound.IsSfxPlaying(SfxID.Car_Skid))
                    ManagerRoot.Sound.StopSFX(SfxID.Car_Skid);
            }
        }
        ...
        private void ProcessHit(InteractableObj obj)
        {
            ...
            {
                ManagerRoot.Sound.PlaySFX(SfxID.Coin);
            ...
            {
                ManagerRoot.Sound.PlaySFX((Random.value > 0.5f) ? SfxID.Splatter_1 : SfxID.Splatter_2);
            ...
            {
                ManagerRoot.Sound.PlaySFX(SfxID.Car_Crash);
